...
class ScreenHeaderDesktop extends StatelessWidget {
                  ...
                  Padding(
                    ...
                    child: Consumer(
                      builder: (context, watch, child) {
                        var user = watch(authenticatedUserProvider);
                        return Column(
                          children: [
                            Text(
                              //TODO  read name from authenticatedUuserProvider
                              user.name,
                            ...
                            Text(
                              //TODO  read Roles from authenticatedUserProvider
                              user.userId,
                              overflow: TextOverflow.ellipsis,
                              style: GoogleFonts.raleway(
                                  fontSize: 10,
  ...
  Row buildClockTimer(BuildContext context) {
    return Row(
